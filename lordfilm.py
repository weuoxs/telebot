...
x = 1
url = "https://hg.lordfilm7.link/film2/"
...
while True:
    ...
    while i < len(opisanie_list):
        ...
        cur.execute("""INSERT INTO Triangle_Kino (RESURS, NAME, OPISANIE, LINK_STR) VALUES ( ?, ?, ?, ?);""", (resursZERO, name1, opisanie1, link2))
        db.commit()
        print("Добавлено " + str(i))
        i = i + 1

    x = x + 1
    url = "https://hg.lordfilm7.link/film2/page/" + str(x) + "/"
